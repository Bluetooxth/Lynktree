    ...
    return (
        <section className="relative flex justify-center items-center dotgrid w-full min-h-screen">
            <div className="flex flex-col justify-start items-center container px-5 gap-5 relative z-10">
                ...
                >
                    <h2 className="text-3xl md:text-4xl font-medium text-center w-full">Create your account</h2>
                    ...
                    <button className="bg-cyan-600 hover:bg-cyan-700 px-7 py-2 rounded-lg text-xl slow" type="submit" disabled={loading}>
                    ...
                    <div className="flex flex-col justify-start items-start gap-2 w-full">
                        <p className="flex items-center gap-2">
                            ...
                            <Link href='/login' className="underline text-cyan-600">Login here</Link>
                        </p>
                    </div>
                </form>
            </div>
